...
class Program
{
    static void Main(string[] args)
    {
        ...
        void RunOrders()
        {
            ...
            Console.WriteLine("Color Changing Ends Successfully!");
        ...
        // {
        //     await Task.Run(() => RunListOrder());
        //     await Task.Run(() => QuitProgram());
        // }

        // RunProgram();

        Thread thread1 = new Thread(new ThreadStart(RunOrders));
        thread1.Start();
        Thread thread2 = new Thread(new ThreadStart(QuitProgram));
        thread2.Start();
    }
}